...
type Project={name:string;problem?:string;bullets:string[];stack:{label:string;items:string[]}[];decisions:string[];theme:ProjectTheme;github?:string;demo?:string;status?:string;note?:string;when?:string;tech?:string|string[]}
